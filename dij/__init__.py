...
from .svc import ActivationScope as ActivationScope
from .svc import Services as Services
from .types import ContainerProtocol as ContainerProtocol
from .types import ServiceLifeStyle as ServiceLifeStyle
